        ...
        try:
            with patch.object(connection_manager, 'DB_PATH', temp_db_path):
                ...
                with get_database_pool() as conn1:
                    cursor = conn1.cursor()
                    cursor.execute("CREATE TABLE integration_test (id INTEGER, value TEXT)")
                    cursor.execute("INSERT INTO integration_test (id, value) VALUES (1, 'pool')")
                    conn1.commit()
                ...
                cursor.execute("INSERT INTO integration_test (id, value) VALUES (2, 'direct')")
                conn2.commit()
                conn2.close()

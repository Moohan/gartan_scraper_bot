...
class TestDBStoreEdgeCases:
    ...
    def test_insert_appliance_availability_with_external_connection(self):
        ...
        # Test with external connection
        insert_appliance_availability(appliance_data, db_conn=conn)        # Verify data was inserted
        cursor = conn.cursor()
    ...
    def test_crew_availability_with_block_deletion_logging(self):
        ...
        crew_data = [{
            ...
            'contact': 'Test Contact',
            'skills': 'TTR',
            'availability': {'05/08/2025 0900': True, '05/08/2025 1000': True, '05/08/2025 1100': False}
        }]
        ...
        crew_data_same_dates = [{
            ...
            'contact': 'Test Contact',
            'skills': 'TTR',
            'availability': {'05/08/2025 0800': True, '05/08/2025 0900': False, '05/08/2025 1200': True}
        }]
    ...
    def test_database_commit_error_handling(self):
        ...
        with patch('sqlite3.connect') as mock_connect:
            ...
            mock_conn.commit.side_effect = sqlite3.Error("Commit failed")            # This should raise the commit error
            with pytest.raises(sqlite3.Error):
                insert_crew_availability(crew_data)
...
class TestDBStoreFunctionality:
    ...
    def test_concurrent_connections(self):
        ...
        insert_crew_details(crew_data2, contact_map2, conn2)        # Insert data using both connections
    ...
    def test_data_integrity_constraints(self):
        ...
        from db_store import insert_crew_details
        contact_map = {
            'DUPLICATE, T': 'Contact 1'  # Only first contact will be used
        }
        insert_crew_details(crew_data, contact_map)

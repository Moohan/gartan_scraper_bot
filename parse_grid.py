...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    The HTML is parsed into a BeautifulSoup object once at the beginning
    of this function. This object is then passed to the various parsing
    sub-functions (`_get_table_and_header`, `parse_appliance_availability`,
    `parse_skills_table`), avoiding the significant overhead of re-parsing
    the same HTML string multiple times.
    """

...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    Bolt ⚡: This function was optimized by creating the BeautifulSoup object
    once and passing it to downstream parsers, avoiding redundant parsing of the
    same HTML string multiple times. This is significantly more efficient.
    """
    # Create the BeautifulSoup object once to avoid re-parsing the same string.

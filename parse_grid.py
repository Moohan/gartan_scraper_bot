...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    # Bolt ⚡: Inefficient to parse the same HTML multiple times.
    # Create the soup object once and pass it to the helper functions.
    # This reduces CPU overhead, especially when parsing many pages concurrently.

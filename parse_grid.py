...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    # Bolt ⚡: Parse the HTML once at the top level, then pass the soup object
    # to subsidiary functions. This avoids re-parsing the same document
    # multiple times, which is a significant performance bottleneck.

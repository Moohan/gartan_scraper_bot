...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    Bolt ⚡: This function is performance-critical. The HTML is parsed into a
    BeautifulSoup object once and then passed to downstream functions to avoid
    redundant and expensive parsing, which was a key bottleneck.
    """

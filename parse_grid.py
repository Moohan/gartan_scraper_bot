...
def parse_grid_html(grid_html: str, date: Optional[str] = None) -> GridResult:
    ...
    # Bolt ⚡: Create the BeautifulSoup object once to avoid re-parsing the HTML
    # in multiple functions. This is a significant performance improvement for the
    # CPU-bound parsing task.

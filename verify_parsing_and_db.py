...
from db_store import init_db, insert_crew_details, insert_crew_availability, insert_appliance_availability
...
def verify():
    ...
    if crew_list:
        ...
        c.execute("SELECT start_time, end_time FROM crew_availability WHERE crew_id=? LIMIT 5", (crew_id,))
        rows = c.fetchall()

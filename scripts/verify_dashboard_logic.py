...
def setup_mock_db():
    ...
    c = conn.cursor()
    c.execute("INSERT INTO crew (name, role, skills, contract_hours) VALUES ('Test Officer', 'WC', 'BA TTR', '42h')")
    c.execute("INSERT INTO crew (name, role, skills, contract_hours) VALUES ('Test Driver', 'FFD', 'BA LGV', '42h')")
    c.execute("INSERT INTO crew (name, role, skills, contract_hours) VALUES ('Test FF1', 'FF', 'BA', '42h')")
    c.execute("INSERT INTO crew (name, role, skills, contract_hours) VALUES ('Test FF2', 'FF', 'BA', '42h')")
